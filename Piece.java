...
public class Piece extends FilledOval {
    ...
    public Piece(int value, int row, int col, Location loc, int size, DrawingCanvas canvas) {
        ...
        //super makes a filled oval, but I made a variable 'circle' to refer to the oval i will use in the game
    ...
    public static void startingPos(Piece[][] pieces, Square[][] squares) {
        ...
        //red pieces
        for (int j = 0; j < 12; j++) {
            //gray pieces only occupy last 3 rows at start
//if the row is odd, set the pieces to col 1, 3, 5, 7 
    ...
    public boolean isValidMove(Square target, Square[][] squaresArray) {

        int rowDif = row - target.getRow(), colDif = col - target.getCol();

        //if the square is not empty, you cannot move there!!!
        if (target.getValue() != 0) {
            //System.out.println(rowDif);
            //System.out.println(colDif);
            System.out.println("target value > 0");
            return false;
        }
        ...
        if (rowDif == 0 || colDif == 0) {
            //System.out.println(rowDif);
            //System.out.println(colDif);
            System.out.println("move is horizontal/vertical");
            return false;
        }


       /* double dif = rowDif / colDif;
	...
	/*		
			...
			// Board starts at bottom left as a grey square 1,1
